...
#Author: Micah Gooden
#
#Purpose: Tech Academy Python Course Tutorial
#               Working on how to pass variables from function to function
#               Creating a functional game.
#
#               Rememver, function_name(variable)_means that we pass in the variable.
#               return variable _means that we are returning the variable back to the calling function
import pygame
pygame.mixer.init()
winSound=pygame.mixer.Sound('winGame.wav')
...
def describe_game(name):
    ...
    if name !="":
        print("n\Thank you for playing again, {}!".format(name))
    else:
        stop=True
        while stop:
            if name=="":
